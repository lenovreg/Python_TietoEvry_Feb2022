...
#
print(tel['valdis'])
# print(tel['joker']) # KeyErroryou would have to handle errors in try: block or we could check first
...
print(tel.get("NoSuchKey"), "Sorry no such key found")
...
new_dict_2 = {key:value for key,value in tel.items() if value <= 2_000_000}
