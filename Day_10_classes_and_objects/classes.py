...
class House:
    ...
    def print_house_prop(self):  # method defintion which is function associated with objects
...
class Garage:
    ...
    # this method really has no place inside here, since it has nothign to do with garage..
    def add(self, a, b):
